...
export class SettingsComponent implements OnInit {
  ...
  uploadLogo() {
    ...
    this.serverService.post('manager/upload_school_logo', formData, true).subscribe(
      (resp) => {
        swal({
          title: 'Success',
  ...
  getClassTypes() {
    this.server.get('manager/get_class_type_list', true).subscribe(resp => {
      if (resp['code'] === 200) {
  ...
  schoolSubmit() {
    ...
    this.serverService.post('manager/edit_school', {
  ...
  classTypeSubmit() {
    this.serverService.post('manager/' + this.classTypeRequestType + '_class_type', {
      id: this.classTypeId,
  ...
  classSubmit() {
    this.serverService.post('manager/' + this.classRequestType + '_class', {
      id: this.classId,
      name: this.className,
      type: this.classType,
  ...
  holidaySubmit() {
    this.serverService.post('manager/' + this.holidayRequestType + '_holiday', {
      id: this.holidayId,
  ...
  mealSubmit() {
    this.serverService.post('manager/' + this.mealRequestType + '_meal', {
      id: this.mealId,
      name: this.mealName,
  ...
  ngAfterViewInit(): void {
    ...
    $('#classTypesTable').DataTable({
      ...
      aaSorting : [[1, 'desc']],
      ajax: {
        url: this.server.baseUrl + 'manager/get_class_types',
        type: 'POST',
    ...
    classTypesTable.on('click', '.remove', function (e: any) {
      swal({
        ...
        thisObj.server.delete('manager/delete_class_type/' + data.id, true).subscribe(
          (resp) => {
    ...
    $('#classesTable').DataTable({
      ...
      aaSorting : [[1, 'desc']],
      ajax: {
        url: this.server.baseUrl + 'manager/get_classes',
        type: 'POST',
        headers: {'Authorization': this.authService.getToken()},
    ...
    classesTable.on('click', '.remove', function (e: any) {
      swal({
        ...
        const $tr = $(this).closest('tr');
        const data = classesTable.row($tr).data();
        thisObj.server.delete('manager/delete_class/' + data.id, true).subscribe(
          (resp) => {
    ...
    $('#holidaysTable').DataTable({
      ...
      aaSorting : [[1, 'desc']],
      ajax: {
        url: this.server.baseUrl + 'manager/get_holidays',
        type: 'POST',
        headers: {'Authorization': this.authService.getToken()},
        dataSrc: function(res){
    ...
    holidaysTable.on('click', '.remove', function (e: any) {
      swal({
        ...
        const $tr = $(this).closest('tr');
        const data = holidaysTable.row($tr).data();
        thisObj.server.delete('manager/delete_holiday/' + data.id, true).subscribe(
          (resp) => {
    ...
    $('#mealsTable').DataTable({
      ...
      aaSorting : [[1, 'desc']],
      ajax: {
        url: this.server.baseUrl + 'manager/get_meals',
        type: 'POST',
        headers: {'Authorization': this.authService.getToken()},
        dataSrc: function(res){
    ...
    mealsTable.on('click', '.remove', function (e: any) {
      swal({
        ...
        const $tr = $(this).closest('tr');
        const data = mealsTable.row($tr).data();
        thisObj.server.delete('manager/delete_meal/' + data.id, true).subscribe(
          (resp) => {
  ...
  getSchoolInfo() {
    this.server.get('manager/get_school_info', true).subscribe(resp => {
      if (resp['code'] === 200) {
